...
ACLOCAL = ${SHELL} '/d/EDABK-DNS/missing' aclocal-1.16
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = ar
AUTOCONF = ${SHELL} '/d/EDABK-DNS/missing' autoconf
AUTOHEADER = ${SHELL} '/d/EDABK-DNS/missing' autoheader
AUTOMAKE = ${SHELL} '/d/EDABK-DNS/missing' automake-1.16
AWK = gawk
CC = gcc
...
LT_SYS_LIBRARY_PATH = 
MAINT = 
MAKEINFO = ${SHELL} '/d/EDABK-DNS/missing' makeinfo
MANIFEST_TOOL = :
...
STRIP = strip
VERSION = unknown
abs_builddir = /d/EDABK-DNS
abs_srcdir = /d/EDABK-DNS
abs_top_builddir = /d/EDABK-DNS
abs_top_srcdir = /d/EDABK-DNS
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /d/EDABK-DNS/install-sh
