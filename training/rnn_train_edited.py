# -*- coding: utf-8 -*-
"""RNNoise_training.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1yB6ovanVuftLNXui961s1-P5NHN7X_rF
"""
...
print('Loading data...')
with h5py.File('/content/gdrive/MyDrive/Dataset/training.h5', 'r') as hf:
    print(hf['data'])
    exit
    all_data = hf['data'][:]
print('done.')
